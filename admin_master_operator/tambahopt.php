              ...
              <div class="col-lg-6">
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title"><i class="nav-icon fas fa-plus"></i> Tambah Data Operator</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="proses.php" method="post">
                    <div class="card-body">
                      <a href="../admin_master_operator" class="btn btn-warning btn-sm"><i class="nav-icon fas fa-chevron-left"></i> Kembali</a>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" maxlength="150" placeholder="Input Nama Operator" required>
                      </div>
                      <div class="form-group">
                        <label for="kontak">Kontak</label>
                        <input type="kontak" class="form-control" id="kontak" name="kontak" maxlength="50" placeholder="Input Kontak" required>
                      </div>
                      <div class="form-group">
                        <label for="foto">Foto</label>
                        <input type="foto" class="form-control" id="foto" name="foto" maxlength="50" placeholder="Input Foto" required>
                      </div>
                    </div>
                    <!-- /.card-body -->

                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary btn-block" name="tambahopt"><i class="nav-icon fas fa-plus"></i> Tambah Data</button>
                    </div>
                  </form>
                </div>
                <!-- /.card -->
