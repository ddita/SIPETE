...
<body>
    ...
    if (isset($con, $_POST['tagihan'])) {
        ...
        if ($kode_bank != '100') {
            ...
            $penambahansaldocash = $saldo_cash + $jumlah;
            ...
            echo "<script>alert('Transaksi berhasil.'); window.location = '../admin_nota_transaksi/index.php';</script>";           
        } else {
